      ...
      <div className="container quality_main">
        <div className="quality__container">
          <div className="quality__content_left">
            ...
            <h2>Digital Freight That Saves Your Time!</h2>
          </div>
          <div className="quality__content_right">
            <p>
              ...
              utilising communications, tracking and processing software,
              combined with decades of experience! Through integrated supply
              chain solutions, Equita drives sustainable competitive advantages
 ...
 Professional and
        ...
        <div className="quality__images">
          ...
          <div className="sub_container_images not_Active">
              ...
              <h3 className="company_card_h3">Imran Price, Certified Forwarders</h3>{" "}
              <svg
            width={20.8}
            height={20}
            xmlns="http://www.w3.org/2000/svg" 
