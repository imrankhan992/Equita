...
>
  <SwiperSlide>
    <div className="slider-container">
      ...
      <div className="slider-content container">
        <span>Flexible, Improved, and Accelerated Solutions</span>
  ...
  <SwiperSlide>
    <div className="slider-container">
      <img src={slider1} alt="a man checking the construction work" />
      <div className="slider-content container">
        <span>Your Flexible Road Direction!</span>
        <h1>Your Flexible Road Direction!</h1>
        <p>Representative logistics operator providing full range of service in the sphere of customs clearance and transportation worldwide.</p>
        <div className="sliders-buttons">
          <button className="button-red">More About Us</button>
          <button className="button-black">Our Services</button>
  ...
  <SwiperSlide>
    <div className="slider-container">
      <img src={"https://demo.zytheme.com/equita/assets/images/sliders/3.jpg"} alt="a man checking the construction work" />
      <div className="slider-content container">
        <span>Your Flexible Road Direction!</span>
        <h1>full sustainable cargo solutions!</h1>
        <p>Representative logistics operator providing full range of service in the sphere of customs clearance and transportation worldwide.</p>
  ...
  <SwiperSlide>
    <div className="slider-container">
      <img src={"https://demo.zytheme.com/equita/assets/images/sliders/2.jpg"} alt="a man checking the construction work" />
      <div className="slider-content container">
        <span>Your Flexible Road Direction!</span>
        <h1> Air Freight that saves your time!</h1>
        <p>Representative logistics operator providing full range of service in the sphere of customs clearance and transportation worldwide.</p>
        <div className="sliders-buttons">
          <button className="button-red">More About Us</button>
          <button className="button-black">Our Services</button>
